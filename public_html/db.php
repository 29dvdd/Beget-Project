...
$db   = 'b9626214_test'; // Имя базы данных (из панели MySQL)
$user = 'b9626214_test'; // Имя пользователя (часто совпадает с именем БД)
$pass = 'Parol123'; // Пароль, который вы задали при создании БД
